...
const MusicPlayer: React.FC<MusicPlayerProps> = ({
  musicUrl = "/path/to/your/music.mp3", // Ganti dengan path musik Anda
  className = "",
}) => {
    ...
    <>
      ...
      <div
        className={`
          ...
          ${isScrolled && !isHovered ? "transform translate-x-9 opacity-40" : "transform translate-x-0 opacity-100"}
          ${className}
        `}
